<template scoped>
  <div class="content-root minecraft-content">
    <div class="skyblock"><img src="/skyblocknew.png"/></div>

    <div class="content-root-next">
      <Section 
        brightness="100%" 
        opacity="0.15" 
...
<script>
import Section from '~/components/minecraft/index/Section.vue'
export default { 
  name: 'Content',
  components: {
    Section
